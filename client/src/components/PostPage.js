    ...
    return (
        <div className='post-page-container'>
            <div className='post-page-container-title'>
                ...
                <input className='post-page-container-title-input' required type='string' name='blogTitle'/>
            </div>
            <div className='post-page-container-description'>
                <h3>Description of the blog post (recommended 300 characters or less): </h3>
                <input className='post-page-container-description-input' required type='string' name='blogDescription'/>
            </div>
            <div className='post-page-container-author'>
                <h3>Names of the author(s) who have contributed to the blog post:</h3>
                <input className='post-page-container-author-input' required type='string' name='blogAuthor'/>
            </div>
            <div className='post-page-container-body'>
                <h3>The body of your blog post:</h3>
                <input className='post-page-container-body-input' required type='string' name='blogBody'/>
            </div>
            <div className='post-page-container-blogImgUrl'>
                <h3>URL of the thumbnail image for your post (optional):</h3>
                <input className='post-page-container-blogImgUrl-input' type='string' name='blogImgUrl'/>
            </div>
            <div className='post-page-container-blogTags'>
                <h3>Tags for your post (optional):</h3>
                <input className='post-page-container-blogTags-input' type='string' name='blogTags'/>
            </div>
            <div className='post-page-container-blogDate'>
                <h3>Date of the post:</h3>
                <input className='post-page-container-blogDate-input' type='string' name='blogDate'/>
            </div>
        </div>
    )
}
